...
const mol3D = (node) => (stream) => {
  // Get Params
  let color = node.data.state?.colormode || 2;
  let render  = node.data.state?.render || 0;
  // Get source.s
...
export const mol_renderer_ui =   {
  id: "MOL_RENDERER",
  class: "rendering",
  description: "Renderer",
  tags: ["cpk","lut","rainbow","wireframe","backbone","trace","cartoon","strands","ball-and-stick"],
  func: mol3D,
  ui: [
    [
